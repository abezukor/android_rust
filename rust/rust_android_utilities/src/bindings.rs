...
pub mod com {
    ...
    pub mod maticrobots {
        ...
        pub mod rust_android_utilities {
            ...
            #[repr(transparent)]
            pub struct RustArcBoxDynAny(pub(crate) ::java_spaghetti::ObjectAndEnv);
                ...
                > {
                    ...
                    unsafe {
                        ...
                        let (__jni_class, __jni_method) = __jni_env.require_class_method(
                            "com/maticrobots/rust_android_utilities/RustArcBoxDynAny\0",
                            "<init>\0",
                            "(J)V\0",
                        );
            ...
            #[repr(transparent)]
            pub struct RustInitialization(pub(crate) ::java_spaghetti::ObjectAndEnv);
            ...
            impl RustInitialization {
                ...
                > {
                    ...
                    unsafe {
                        let __jni_args = [];
                        let (__jni_class, __jni_method) = __jni_env.require_class_method(
                            "com/maticrobots/rust_android_utilities/RustInitialization\0",
                            "<init>\0",
                            "()V\0",
                        );
                        __jni_env.new_object_a(__jni_class, __jni_method, __jni_args.as_ptr())
        ...
        impl String {
            ...
            > {
                ...
                unsafe {
                    ...
                    let __jni_env = ::java_spaghetti::Env::from_raw(self.0.env);
                    let (__jni_class, __jni_method) =
                        __jni_env.require_class_method("java/lang/String\0", "indent\0", "(I)Ljava/lang/String;\0");
                    __jni_env.call_object_method_a(self.0.object, __jni_method, __jni_args.as_ptr())
                }
            }
            ...
            > {
                ...
                unsafe {
                    ...
                    let __jni_env = ::java_spaghetti::Env::from_raw(self.0.env);
                    let (__jni_class, __jni_method) =
                        __jni_env.require_class_method("java/lang/String\0", "stripIndent\0", "()Ljava/lang/String;\0");
                    __jni_env.call_object_method_a(self.0.object, __jni_method, __jni_args.as_ptr())
                }
            }
